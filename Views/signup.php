...
<form id="signup" action="<?php echo FRONT_ROOT ?>User/signUp" method="POST">
    ...
    <input type="text" name="firstname" id="firstname" placeholder="First Name" required="required" pattern="[A-Za-z]" title="Solo letras">
    <input type="text" name="lastname" id="lastname" placeholder="Last Name" required="required" pattern="[A-Za-z]" title="Solo letras">
